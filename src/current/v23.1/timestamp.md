...
<!-- [XXX](): Update examples with Bram's timestamp conversion stuff -->
...
### Convert seconds since epoch to timestamp if it's an int
...
### Convert seconds since epoch to timestamp if it's a string
...
### Convert milliseconds since epoch to timestamp if it's an int
...
### Convert milliseconds since epoch to timestamp if it's a string
...
### Convert microseconds since epoch to timestamp if it's an int
...
### Convert microseconds since epoch to timestamp if it's a string
