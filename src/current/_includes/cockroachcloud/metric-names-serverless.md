The following is a list of available metrics for use in the Custom Chart page. Currently, the listed metrics are intended to be used by CockroachDB {{ site.data.products.serverless }} clusters.
