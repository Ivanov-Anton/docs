...
- [Create **Custom** metric charts](#create-custom-metric-charts)
...
See the [Custom Metric Chart page]({% link cockroachcloud/custom-metric-chart-page.md %}) for more details.
